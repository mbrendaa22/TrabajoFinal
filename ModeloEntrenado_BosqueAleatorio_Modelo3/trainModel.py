...
Original file is located at
    https://colab.research.google.com/drive/14F4T266gyfyr2nmUEytEE-HNSyZt8IaT
"""
...
data = pd.read_excel('/content/datosEntrenarModelo_BA.xlsx')
...
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=365/1095)
...
# Guardar modelo entrenado usando joblib
